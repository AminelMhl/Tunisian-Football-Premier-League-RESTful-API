...
describe('FantasyService', () => {
  ...
  it('should create a fantasy team', async () => {
    ...
    prisma.fantasyTeam.create.mockResolvedValue({ id: 1, ...dto, userId, totalPoints: 0 });
  ...
  it('should update points after a match', async () => {
    ...
    prisma.fantasyTeam.findMany.mockResolvedValue([{ id: 1, name: 'Team A', userId: 1, totalPoints: 4 }]);
    prisma.fantasyTeam.update.mockResolvedValue({ id: 1, name: 'Team A', userId: 1, totalPoints: 4 });
  ...
  it('should return the leaderboard', async () => {
    ...
    prisma.fantasyTeam.findMany.mockResolvedValue(result);
